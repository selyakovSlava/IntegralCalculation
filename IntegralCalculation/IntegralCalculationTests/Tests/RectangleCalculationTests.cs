...
{
    public class RectangleCalculationTests : ITestable
    {
        /// <summary>
        /// Точность округления.
        /// </summary>
        ...
        public RectangleCalculationTests()
        {
            MessageThrowable = new ThrowMessages();
            Calculator = new RectangleCalculation(MessageThrowable);
        }
        ...
        {
            double testResult = Math.Round(0.7853981842307827, _roundingAccuracy);
